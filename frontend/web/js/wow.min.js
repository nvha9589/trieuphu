...
(function () {
    ...
    b = function () {
        ...
        return a.prototype.extend = function (a, b) {
            ...
            function a() {console.warn("MutationObserver is not supported by your browser. WOW.js cannot animate asynchronously loaded content.")}

            return a.prototype.observe = function () {}, a
        }()), this.WOW = function () {
        function e(a) {null == a && (a = {}), this.scrollCallback = d(this.scrollCallback, this), this.scrollHandler = d(this.scrollHandler, this), this.start = d(this.start, this), this.scrolled = !0, this.config = this.util().extend(a, this.defaults), this.animationNameCache = new c}
        ...
        return e.prototype.defaults = {boxClass: "wow", animateClass: "animated", offset: 0, mobile: !0, live: !0}, e.prototype.init = function () {
            ...
            var b, c, d, e;
            if (this.stopped = !1, this.boxes = this.element.getElementsByClassName(this.config.boxClass), this.boxes.length)if (this.disabled())this.resetStyle(); else {
            ...
            return this.config.live ? new a(function (a) {
                return function (c) {
                    ...
                    if (!a.stopped) {
                        for (d = [], g = 0, j = c.length; j > g; g++)for (f = c[g], m = f.addedNodes || [], h = 0, k = m.length; k > h; h++)e = m[h], e.classList.contains(a.config.boxClass) && d.push(e);
                        for (i = 0, l = d.length; l > i; i++)b = d[i], a.applyStyle(b, !0);
                        return (n = a.boxes).push.apply(n, d)
                    }
                }
            }(this)).observe(document.body, {childList: !0, subtree: !0}) : void 0
        }, e.prototype.stop = function () {return this.stopped = !0, window.removeEventListener("scroll", this.scrollHandler, !1), window.removeEventListener("resize", this.scrollHandler, !1), null != this.interval ? clearInterval(this.interval) : void 0}, e.prototype.show = function (a) {return this.applyStyle(a), a.className = "" + a.className + " " + this.config.animateClass}, e.prototype.applyStyle = function (a, b) {
            var c, d, e;
        ...
        }, e.prototype.util = function () {return this._util || (this._util = new b)}, e.prototype.disabled = function () {return !this.config.mobile && this.util().isMobile(navigator.userAgent)}, e
    }()
}).call(this);