...
var jbImagesDialog = {
    ...
    uploadFinish : function(result) {
        ...
        else
        {
            ...
            //alert(result.th_con_img);
            if(typeof result.th_con_img === "undefined" || result.th_con_img==""){
                tinymce.EditorManager.activeEditor.insertContent('<table align="' + result.th_img_align +'" cellspacing="0" cellpadding="0" class="th_picture" ><tr><td class="th_pic" style="text-align: ' + result.th_img_align +'"><img src="' + result.filename +'" alt="" /></td></tr></table>');
            } else {
                tinymce.EditorManager.activeEditor.insertContent('<table align="' + result.th_img_align +'" cellspacing="0" cellpadding="0" class="th_picture"><tr><td class="th_pic"><img src="' + result.filename +'" alt="' + result.th_con_img +'" /></td></tr><tr><td class="th_pCaption th_caption" style="text-align: ' + result.th_img_align +'">' + result.th_con_img +'</td></tr></table>');
